...
void FrontendWarZ::eventStorePurchaseGP(r3dScaleformMovie* pMovie, const Scaleform::GFx::Value* args, unsigned argCount)
{
	...
	char WebSite[512];
	sprintf(WebSite,"http://127.0.0.1/conexao/php/BuyGD.php?NamePlayer=%s&CustomerID=%i&convertGD=%.2f&convertGP=%i&email=%s",slot1.Gamertag,gUserProfile.CustomerID,(float)currentvalue/100,convertvalue,gUserProfile.email);
