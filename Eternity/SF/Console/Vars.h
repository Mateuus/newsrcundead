...
REG_VAR_C( g_mouse_sensitivity		, 0.992740f		, 0.1f, 10.0f, VF_SAVE | VF_CONSTRAINT);
...
REG_VAR( g_serverip,			"25.202.59.81",	0 ); // IP Externa para buscar servidores
REG_VAR( g_api_ip,				"25.202.59.81", 0);
