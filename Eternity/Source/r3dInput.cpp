...
r3dInputMappingMngr::r3dInputMappingMngr()
{
	...
	m_Mapping[KS_GRAVE] =					KeyboardMapping(INPUTMAP_KEYBOARD, kbsY, "$HUD_Y");
	...
	m_Mapping[KS_TOGGLE_FLASHLIGHT] = KeyboardMapping(INPUTMAP_KEYBOARD, kbsF, "$HUD_Cntrl_Toggle_Flashlight");

	m_Mapping[KS_CRAFT] =			KeyboardMapping(INPUTMAP_KEYBOARD, kbsK, "$HUD_Cntrl_ShowCraftMenu");
}
