...
static void UpdateChar_SetBackpack(CWOBackendReq& req, const wiCharDataFull& cur, const wiCharDataFull& old)
{
	...
	for(int i=0; i<wiCharDataFull::CHAR_MAX_BACKPACK_SIZE; i++)
	{
		...
		//r3dOutToLog("### backpack slot %d changed %d -> %d - Durability %f\n", i, w2.itemID, w1.itemID,w1.Durability);
		...
		sprintf(value, "%d %d %d %d %d %d %d", i, op, w1.itemID, w1.quantity, w1.Var1, w1.Var2/*, w1.Durability*/);
